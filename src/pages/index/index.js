...
import { NotesOutlined, LikeOutlined } from "@taroify/icons";
  ...
  return (
    <View className={styles.wrapper}>
      {/* <Image
        ...
        src="http://121.199.8.71/_next/image?url=%2Fimages%2Ftest1.png&w=3840&q=65"
        ...
        <View className={styles.content}>
          <View>
            <Button
              ...
              size="small"
              variant="contained"
              icon={<NotesOutlined size="20px" style={{ color: "#fff" }} />}
              style={styles2.btn}
              onClick={() =>
                Taro.navigateTo({
          ...
          <View>
            <Button
              ...
              size="small"
              variant="contained"
              icon={<LikeOutlined size="20px" style={{ color: "#fff" }} />}
              style={styles2.btn}
              onClick={() =>
                Taro.navigateTo({
